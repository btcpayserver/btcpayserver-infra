...
psql="docker exec -i btcpayserver-infra-mattermost_db-1 psql -U mmuser -d mattermost"
...
find /var/lib/docker/volumes/btcpayserver-infra_mm-data/_data -type d | grep $userid | tr "\n" "\0" | xargs -0 rm -rf
